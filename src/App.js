  ...
  return (
    <div className="App">
      ...
      <Navigation  setSearch = {setSearch} setRating = {setRating}></Navigation>
        ...
        <Route  exact path='/tuni-best'    render={(props)=>  <Home  movies={movies} {...props}  ></Home>  }     />
    
      <AddFlex handleAdd={handleAdd} />
   <Route exact path= '/tuni-best'>   <MovieList movies ={movies} search={search} rating={rating} /> </Route>
